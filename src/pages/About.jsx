  ...
  return (
    <section className="bg-[#FFF8F2] pt-20 lg:pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-12 lg:gap-32">
          ...
          >
            <img
              ...
              alt="Shreya Reddy"
              className="w-full h-full object-cover lg:max-h-full lg:max-w-full" // Ensure the image covers the full height on desktop
            />
          </motion.div>
